...
class UpdateCardTagsRequest(BaseModel):
    tags: List[str] = Field(default_factory=list)

class UpdateDeckTagsRequest(BaseModel):
    tags: List[str] = Field(default_factory=list)
...
class MoveCardSideboardRequest(BaseModel):
    isSideboard: bool
...
class DeckDeleteRequest(BaseModel):
    reassignments: Optional[List[Dict[str, Any]]] = None
