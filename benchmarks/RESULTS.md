# Evaluación de importaciones masivas — 2026-09-12
...
|---|---:|---:|---:|
| 1000_lines_1000_unique_warm | 4.572 | 5.119 | 0.088 |
| 1000_lines_1000_unique_cold | 5.733 | 5.547 | 0.054 |
| 5000_lines_5000_unique_warm | 24.837 | 24.316 | 0.344 |
| 5000_lines_5000_unique_cold | 32.635 | 33.673 | 0.214 |
| 5000_lines_1000_unique_warm | 27.867 | 5.194 | 0.120 |
...
|---|---:|---:|---:|
| current_success_5000 | 67 | 5000 | 0 |
| current_failure_last_batch | 67 | 0 | 5000 |
| streaming_failure_last_batch | 67 | 4950 | 50 |
| current_two_overlapping_uploads | 28 | 1000 | 0 |
| coalesced_two_overlapping_uploads | 14 | 1000 | 0 |
| current_one_name_not_found | 67 | 4999 | 1 |
...
- URL: https://data.scryfall.io/oracle-cards/oracle-cards-20260911210155.jsonl.gz
- Tamaño comprimido: 24.60 MB.
- Descarga observada: 0.725 s (una ejecución).
- Lectura y construcción del índice: 0.919 s.
- Registros leídos: 38740; claves: 36029.
- Colisiones al normalizar nombres: 2711.
- Nombres solicitados con clave ambigua: 619. Ejemplos:
  ["Agents of S.H.I.E.L.D.", "Loading Zone // Loading Zone", "Ego Drain // Ego Drain", "Hallowed Haunting", "Goldspan Dragon", "Forgehammer Centurion", "Ozai, the Phoenix King", "Turtle-Duck"]. Lista completa en el JSON.
- Nombres con coincidencia: 5000/5000; sin
  colisión de clave: 4381.
- Mediana de las 5.000 búsquedas: 0.003746 s.
- No resueltos: [].
...
.venv/bin/python benchmarks/bulk_catalog.py --url 'https://data.scryfall.io/oracle-cards/oracle-cards-20260911210155.jsonl.gz'
```
Desde `worker`:
```sh
